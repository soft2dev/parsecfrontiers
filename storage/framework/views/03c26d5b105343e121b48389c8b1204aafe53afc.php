                ...
                <div class="ibox float-e-margins">
                    ...
                    <?php
                        ...
                        "<td>{$campaigner->preTelegramName}</td>".
                         "<td><a><span class='mDelete'>Edit</span>|<span class='mDelete'>Delete</span></a></td></tr>";
                        $i++;
                        }
                        echo $html;
                    ?>
            ...
            <div class="modal-content animated bounceInRight">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <input type="text" name="signUsername" id="txt_wallet_address" class="form-control" placeholder="ETHEREUM WALLET ADDRESS" value="">
                        </div>  
                        <div class="form-group">
                            <input type="email" name="signEmail" id="txt_twitter_account" class="form-control" placeholder="TWITTER ACCOUNT NAME" value="">
                        </div>
                        <div class="form-group">
                            <input type="text" name="signMobileNumber" id="txt_telegram_name" class="form-control" placeholder="TELEGRAM NAME" value="">
                        </div>
                        <div class="form-group">
                            <input type="password" name="signPassword" id="txt_pre_telegram_name" class="form-control" placeholder="REFERRE'S TELEGRAM NAME" value="">
                        </div>
                    </div>
